        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlantTypeName = table.Column<string>(maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductInfos_PlantTypes_PlantTypeID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInfos_PlantTypeID",
                table: "ProductInfos",
                column: "PlantTypeID");

            var backupFile = Path.Combine(".\\backups", @"GreenAura_db_scripts.sql");
